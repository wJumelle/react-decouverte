        ...
        return (
            <form>
                ...
                <p>
                    <label>
                        <input type="checkbox" />
                        Montrer uniquement les produits en stocks
                    </label>
                </p>
            </form>
        )
...
class FilterableProductTable extends React.Component {
    render() {
        return (
            <div>
                <h2>Version statique de l'application de fin de formation</h2>
                <SearchBar />
...
// Penser en React - dynamique 

class FilterableProductTableDyn extends React.Component {
    render() {
        return (
            <div>
                <h2>Version dynamique de l'application de fin de formation</h2>
            </div>
        )
    }
}
...
ReactDOM.render(
    <FilterableProductTableDyn products={PRODUCTS} />, 
    document.getElementById('app-penserReactDynamique')
);